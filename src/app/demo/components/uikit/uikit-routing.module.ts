...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'panels-copy', data: { breadcrumb: 'Panel-2' }, loadChildren: () => import('./panels-copy/panelsdemo2.module').then(m => m.PanelsDemoModule) },
        { path: 'panels-copy-2', data: { breadcrumb: 'Panel-3' }, loadChildren: () => import('./panels-copy-2/panelsdemo3.module').then(m => m.PanelsDemoModule) },
        { path: 'panels-copy-3', data: { breadcrumb: 'Panel-4' }, loadChildren: () => import('./panels-copy-3/panelsdemo4.module').then(m => m.PanelsDemoModule) },
